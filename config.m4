...
if test "$PHP_BEAST" != "no"; then
  ...
  PHP_NEW_EXTENSION(beast, beast.c aes_algo_handler.c des_algo_handler.c base64_algo_handler.c xxtea_algo_handler.c beast_mm.c spinlock.c cache.c beast_log.c global_algo_modules.c header.c networkcards.c xxtea.c tmpfile_file_handler.c pipe_file_handler.c file_handler_switch.c shm.c, $ext_shared)
fi
